...
class Page:
    ...
    def export(self, new_location, destination_folder):
        ...
        # Write footer
        page_file.write("<p><span class=\"text-tiny\"><i>Autogenerated using <a href=\"https://github.com/icl-rocketry/PyConfluenceToWikijshttps://wiki.imperial.ac.uk/display/~pm3118\">code baby</a>, from ye olde Confluence Wiki</i></span></p>\n")
