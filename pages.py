...
class Page:
    ...
    def export(self, new_location, destination_folder):
        '''
        Function to get the content of the page, and export it in the correct form and location
        within the destination folder.

        Takes a two arguments; the location within the hierarchy, and the destination folder. 
        reates folders as neccessary within that folder such as to emulate the previous hierarchy.
        '''
        ...
        # Write content
        page_file.write(str(self._content))

        # Write footer
        page_file.write("<p><span class=\"text-tiny\"><i>Autogenerated using <a href=\"https://github.com/icl-rocketry/PyConfluenceToWikijs\">code baby</a>, from ye olde Confluence Wiki</i></span></p>\n")
        ...
        media_folder = os.path.join(new_dir, "attachments")
        os.makedirs(media_folder, exist_ok=True)
        copy_tree(os.path.join(self.path, "attachments", self.id), os.path.join(media_folder, self.id))
